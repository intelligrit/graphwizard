...
func TestBFS_Chain(t *testing.T) {
	...
	visited := BFS(context.Background(), g, 0)
	if len(visited) != 4 {
...
func TestDFS_Chain(t *testing.T) {
	...
	visited := DFS(context.Background(), g, 0)
	if len(visited) != 3 {
...
func TestBFSPath_Chain(t *testing.T) {
	...
	path := BFSPath(context.Background(), g, 0, 3)
	if len(path) != 4 {
...
func TestBFSPath_NoPath(t *testing.T) {
	...
	path := BFSPath(context.Background(), g, 0, 1)
	if path != nil {
...
func TestBFSPath_SameNode(t *testing.T) {
	...
	path := BFSPath(context.Background(), g, 0, 0)
