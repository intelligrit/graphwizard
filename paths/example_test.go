...
func ExampleShortestPath() {
	...
	nodes, weight := paths.ShortestPath(context.Background(), g, 0, 2)
...
func ExampleYenKShortest() {
	...
	kpaths := paths.YenKShortest(context.Background(), g, 0, 3, 2)
...
func ExampleAStar() {
	...
	nodes, weight := paths.AStar(context.Background(), g, simple.Node(0), simple.Node(2), h)
	fmt.Printf("hops: %d, weight: %.0f\n", len(nodes)-1, weight)
...
func ExampleAllShortestPaths() {
	...
	allPaths := paths.AllShortestPaths(context.Background(), g)
...
func ExampleFloydWarshall() {
	...
	allPaths, ok := paths.FloydWarshall(context.Background(), g)
...
func ExampleBellmanFord() {
	...
	_, weight, ok := paths.BellmanFord(context.Background(), g, 0, 2)
