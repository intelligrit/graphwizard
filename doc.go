...
// Package graphwizard provides graph algorithms compatible with gonum/graph
// interfaces. It fills gaps in gonum's algorithm coverage with cleanroom
// implementations from academic papers, and wraps gonum's own algorithms
// under a unified, consistent API.
//
